...
public class Character {
    ...
    // Method to get character information by name
    public LinkedList<String> getCharacterInformation(String name) {
        int index = characterContainer.indexOf(name);
        if (index != -1) {
            return characterInformation.get(index);
        }
